		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="javscript:void(0)"  rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
					...
					<div class="smallpic">
						...
						<div class="smallpic_wrap">
							<ul>
								<li class="cur">
									<a class="zoomThumbActive" href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m1.jpg',largeimage: 'images/preview_l1.jpg'}"><img src="http://admin.yiishop.com/<?=$good->logo?>"></a>
								</li>
								<li>
									<a href="javascript:void(0);" rel="{gallery: 'gal1', smallimage: 'images/preview_m2.jpg',largeimage: 'images/preview_l2.jpg'}"><img src="http://admin.yiishop.com/<?=$good->logo?>"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
									rel="{gallery: 'gal1', smallimage: 'images/preview_m3.jpg',largeimage: 'images/preview_l3.jpg'}">
	    							<img src="http://admin.yiishop.com/<?=$good->logo?>"></a>
								</li>
								<li>
									<a href="javascript:void(0);"
				...
				<div class="goodsinfo fl ml10">
					...
					<form action="<?=\yii\helpers\Url::to(['member/add-good'])?>" method="post" class="choose">
						<ul>
